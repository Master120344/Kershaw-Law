...
// initScrollAnimations function was removed
...
document.addEventListener('DOMContentLoaded', () => {
    initPageLoad();
    initPageTransitions();
    // initScrollAnimations call removed
    initFooterYear();
    initMobileNavActiveTab();
    initStickyHeaderBehavior(); // Initialize the header behavior
});
